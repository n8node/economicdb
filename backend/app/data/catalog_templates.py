...
CATALOG_TEMPLATES: list[CatalogTemplate] = [
    ...
    CatalogTemplate("eu_unemployment", "Unemployment rate", "eu", "labor", "monthly", "eurostat", "ei_lmhr_m/EA20/UR", "%", "w2"),
    CatalogTemplate("eu_gdp_q_yoy", "GDP, г/г", "eu", "gdp", "quarterly", "eurostat", "namq_10_gdp/EA20/B1GQ", "%", "w2"),
